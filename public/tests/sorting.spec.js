angular.injector(["ng", "ec2pricing.sorting"]).invoke(function (instanceTypeSorter) {
  describe("instaceTypeSorter", function () {
    var micro   = {api_name: "t1.micro",     ecus:  0, ram:  "613 MiB", disk_size: null,       disk_count: 0, architectures:     [64], io_performance: "low",       on_demand_pricing: {linux: 1, mswin: 2, bogus: 3}}
    var xlarge  = {api_name: "m1.xlarge",    ecus:  8, ram:   "15 GiB", disk_size: "1680 GiB", disk_count: 4, architectures:     [64], io_performance: "high",      on_demand_pricing: {linux: 3, mswin: 1, bogus: 3}}
    var cluster = {api_name: "cc2.8xlarge",  ecus: 88, ram: "60.5 GiB", disk_size: "3370 GiB", disk_count: 4, architectures:     [64], io_performance: "very high", on_demand_pricing: {linux: 4, mswin: 4}}
    var medium  = {api_name: "c1.medium",    ecus:  5, ram:  "1.7 GiB", disk_size: "410 GiB",  disk_count: 1, architectures: [32, 64], io_performance: "moderate",  on_demand_pricing: {linux: 2, mswin: 3, bogus: 3}}
    var unsorted = null
    ...
    it("sorts by api_name", function () {
      ...
      expect(sorted).to.deep.equal([micro, cluster, medium, xlarge])
    })
